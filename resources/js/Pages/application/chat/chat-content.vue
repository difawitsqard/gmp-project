<template>
                    ...
                    <div class="messages">
                        ...
                        <div class="chats">
                            ...
                            <div class="chat-content">
                                ...
                                <div
                                    class="message-content award-link chat-award-link"
                                >
                        ...
                        <div class="chats chats-right">
                            <div class="chat-content">
                                <div
                                    class="chat-profile-name justify-content-end"
                                >
                                    <h6>Alex Smith<span>8:16 PM</span></h6>
                                    <div class="chat-action-btns ms-3">
                                        <div class="chat-action-col">
                            ...
                            <div class="chat-content">
                                ...
                                <div class="message-content review-files">
                                    <p class="d-flex align-items-center">
                                        Please check and review the files<span
                                            class="ms-1 d-flex"
                                            ><img
                        ...
                        <div class="chats">
                            ...
                            <div class="chat-content chat-cont-type">
                                <div
                                    class="chat-profile-name chat-type-wrapper"
                                >
                        ...
                        <div class="chat-action-col">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a
                                    ...
                                    class="dropdown-item"
                                    ><span
                                        ><i class="bx bx-volume-full"></i></span
                                    >Audio</a
                                >
                                <a
                                    href="javascript:void(0);"
    ...
    <div
        ...
        id="middle1"
        :class="{
            'show-right-sidebar': showSidebar,
            'hide-right-sidebar': !showSidebar,
        }"
    >
                ...
                >
                    ...
                    >
                        ...
                        <div class="contact-close_call text-end">
                            <a
                                href="javascript:void(0);"
                                class="close_profile close-star"
                            >
                                <i class="bx bxs-star"></i>
                            </a>
                            <a
...
import { myClickHandler } from "@/Pages/application/chat/myFunctions.js";
