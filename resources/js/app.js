...
import Carouselone from "@/Pages/uiinterface/baseui/carousel/carousel-one.vue";
import LightBoxOne from "@/Pages/uiinterface/baseui/lightbox/lightbox-one.vue";
import LightBoxTwo from "@/Pages/uiinterface/baseui/lightbox/lightbox-two.vue";
import Payment from "@/Pages/reports/supplier-report/pos-payment.vue";
import Return from "@/Pages/reports/supplier-report/pos-return.vue";
import Salestax_Report from "@/Pages/reports/tax-report/salestax-report.vue";
import Out_Of_Stocks from "@/Pages/inventory/low-stocks/out-of-stocks.vue";
import ChatContent from "@/Pages/application/chat/chat-content.vue";
import FolderCarousel from "@/Pages/application/folder-carousel.vue";
import FileCarousel from "@/Pages/application/files/files-carousel.vue";
import FileTable from "@/Pages/application/files/file-table.vue";
import NotesCarousel from "@/Pages/application/notes-carousel.vue";
import VectorMap from "@/Pages/dashboard/vector-map.vue";
import ChatImage from "@/Pages/application/chat/chat-images.vue";
import ChatRightimage from "@/Pages/application/chat/chat-right-image.vue";
import ChatRightVideo from "@/Pages/application/chat/chat-right-video.vue";
